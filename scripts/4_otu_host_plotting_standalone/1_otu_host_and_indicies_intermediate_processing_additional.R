...
## -----------------------------------------------------------------------------
## Builds every intermediate object consumed by the Terry-plot rendering script
## (signature tables, taxonomy annotations, prevalence/case-balance filters,
## bucket definitions, and the per-transformation plot configuration lists).
##
## All outputs are written under:
##   results/analyses_results/4_otu_host_plot_out_additional/intermediate/
##
## Environment: R >= 4.5 with data.table, dplyr, tidyr, tibble, purrr, readr,
## stringr, DBI, RSQLite, phyloseq.
...
## package load fails (otherwise users never see 4_otu_host_plot_out_additional/)
## -----------------------------------------------------------------------------
...
message("### Terry Plot Intermediate Processing ###")
