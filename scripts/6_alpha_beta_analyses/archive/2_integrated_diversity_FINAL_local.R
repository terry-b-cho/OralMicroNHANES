#!/usr/bin/env Rscript
################################################################################
##  4. INTEGRATED ALPHA & BETA DIVERSITY ANALYSIS - LOCAL VERSION             ##
...
##  - Local version with full vegan dependency                                 ##
##                                                                             ##
##  USAGE:                                                                     ##
##  - TEST MODE (fast): TEST_MODE <- TRUE (uses 500 samples, ~5 min)          ##
##  - FULL MODE (complete): TEST_MODE <- FALSE (uses 9,349 samples, ~45 min)  ##
################################################################################
