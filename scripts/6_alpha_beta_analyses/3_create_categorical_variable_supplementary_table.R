#!/usr/bin/env Rscript
################################################################################
##  CREATE CATEGORICAL VARIABLE SUPPLEMENTARY TABLE                           ##
##  - Generates comprehensive table of all categorical variables               ##
##  - Includes variable definitions, levels, and reference groups            ##
##  - Outputs both CSV and Markdown formats                                   ##
##  - Supplementary table for publication                                     ##
################################################################################

# Environment: R >= 4.5 with dplyr, tidyr, knitr, readr.
...
cat("[done] Saved Markdown:", md_file, "\n")
