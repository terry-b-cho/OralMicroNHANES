#!/usr/bin/env Rscript
# -----------------------------------------------------------
# Build a schema_structure ("ss_file") matrix for ANY pairing of a
# transformed microbiome table with a user-supplied list of 
# NHANES variables, correctly filtering by cycle (F/G).
# -----------------------------------------------------------
...
if (length(missing_both) > 0) {
  stop("Variables not found in any cycle: ",
